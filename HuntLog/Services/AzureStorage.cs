...
namespace HuntLog.Services
{
    ...
    {
        public const string StorageConnection = "DefaultEndpointsProtocol=https;AccountName=jaktloggen;AccountKey=QOUlEvKgQshvuiKNiXESM1uKH+AA1tOpOWz4mUk+FkIyNvaKfyunYQ0E+gU0EaHI0SYqmXwuIwN3ol04SMBOwQ==;EndpointSuffix=core.windows.net";
